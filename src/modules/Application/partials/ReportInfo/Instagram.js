...
import google from "../../../../assets/image/instagram.png"
  ...
  return (
    ...
    <div className="flex justify-between items-center">       
      <div className="flex flex-col space-y-3 text-gray-600 font-semibold">
        ...
        <div className='text-2xl text-blue-950'>3251 <span className='text-sm text-gray-400'>Click</span></div> 
      </div>
    ...
    <div className="flex justify-between items-center ml-7 mr-7 mt-6 text-justify">
      <div className="text-2xl font-semibold mb-2 text-blue-950">
        <p>214 <span className='text-green-500 text-xs'> 1.7%</span></p>
        <p className=" text-slate-400 text-sm">Audience</p>
      </div>
      <div className="text-2xl font-semibold mb-2 text-blue-950">
        <p>2514<span className='text-red-500 text-xs'> 0.2%</span></p>
